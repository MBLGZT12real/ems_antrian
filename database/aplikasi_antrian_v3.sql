/*
 ...
 Source Schema         : aplikasi_antrian_v3

 Target Server Type    : MySQL
 Target Server Version : 50739 (5.7.39)
 File Encoding         : 65001

 Date: 19/02/2024 11:56:00
*/
...
INSERT INTO `queue_antrian_admisi` (`id`, `tanggal`, `no_antrian`, `code_antrian`, `status`, `updated_date`) VALUES (33, '2024-02-13', '001', 'A', '1', '2024-02-13 00:00:00');
INSERT INTO `queue_antrian_admisi` (`id`, `tanggal`, `no_antrian`, `code_antrian`, `status`, `updated_date`) VALUES (34, '2024-02-13', '001', 'B', '1', '2024-02-13 00:00:00');
INSERT INTO `queue_antrian_admisi` (`id`, `tanggal`, `no_antrian`, `code_antrian`, `status`, `updated_date`) VALUES (35, '2024-02-13', '001', 'C', '0', NULL);
INSERT INTO `queue_antrian_admisi` (`id`, `tanggal`, `no_antrian`, `code_antrian`, `status`, `updated_date`) VALUES (36, '2024-02-13', '002', 'A', '1', '2024-02-13 00:00:00');
INSERT INTO `queue_antrian_admisi` (`id`, `tanggal`, `no_antrian`, `code_antrian`, `status`, `updated_date`) VALUES (37, '2024-02-13', '003', 'A', '1', '2024-02-13 00:00:00');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `queue_setting` (`id`, `nama_instansi`, `logo`, `alamat`, `telpon`, `email`, `running_text`, `youtube_id`, `list_loket`, `list_type_antrian`, `warna_primary`, `warna_secondary`, `warna_accent`, `warna_background`, `warna_text`, `printer`) VALUES (1, 'APLIKASI ANTRIAN LOKET', 'Lambang_Kabupaten_Tanggamus.png', 'Jl. Soekarno Hatta, Komplek Islamic Centre \r\n Kota Agung, Tanggamus', '558450845', 'ade2@mail.com', 'SELAMAT DATANG DI RSUD BATIN MANGUNANG, KOTA AGUNG KAB. TANGGAMUS', 'xVswuC8GKg4', '[{\"no_loket\":\"1\",\"nama_loket\":\"Loket 1\",\"handle_type_antrian\":\"[\\\"A\\\",\\\"B\\\",\\\"S\\\"]\"},{\"no_loket\":\"2\",\"nama_loket\":\"Loket 2\",\"handle_type_antrian\":\"[\\\"A\\\",\\\"B\\\"]\"},{\"no_loket\":\"3\",\"nama_loket\":\"Loket 3\",\"handle_type_antrian\":\"[\\\"A\\\"]\"}]', '[{\"type_antrian\":\"UMUM\",\"code_antrian\":\"A\"},{\"type_antrian\":\"BPJS\",\"code_antrian\":\"B\"},{\"type_antrian\":\"MOBILE JKN\",\"code_antrian\":\"S\"}]', '#4c95cd', '#c39292', '#6083a9', '#3a9862', '#ffffff', '[{\"ip_komputer_printer\":\"192.168.200.189\",\"port_komputer_printer\":\"3000\"}]');
COMMIT;
