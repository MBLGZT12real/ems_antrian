<main class="flex-shrink-0">
    <div class="container">
        ...
        <div class="row gx-3 text-center">
			<!-- link halaman input data antrian -->
            <div class="col-sm-12 mb-3">
                <div class="card border border-success shadow-sm">
                    <div class="card-body p-3">
                        ...
                        <h4 class="fw-bold">INPUT DATA ANTRIAN</h4>
                        <p class="mb-3">Halaman Input Data Antrian digunakan pengunjung untuk mendaftarkan antrian.</p>
                        <a href="index.php?pages=input" class="btn btn-success px-4 py-2">
