					...
					<div class="card border-0 shadow-sm">
						...
						<div class="card-body p-3">
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="panggilan" name="panggilan" placeholder="Nama Panggilan Anda (Maks 10)" maxlength="10" autofocus="on" pattern="[A-Za-z0-9 .,\/\-]+" required>
							</div>
							<div class="mb-3">
							...
							<div class="row">
								<div class="form-group col-6">
									<div class="mb-3">
										...
										<input type="number" class="form-control" id="telepon" name="telepon" placeholder="Nomor WA Aktif Anda" maxlength="20" pattern="[0-9]+" required>
									</div>
								</div>
								<div class="form-group col-6">
									<div class="mb-3">
										<label for="email" class="form-label">Email</label>
										<input type="text" class="form-control" id="email" name="email" placeholder="Alamat Email Anda" maxlength="50">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="card border-0 shadow-sm mt-3">
						...
						<div class="card-body p-3">
							...
							<div class="row">
								<div class="form-group col-6">
									<div class="mb-3">
										...
										<select class="form-control select2" id="typeantri" name="typeantri" onchange="pilihtype(event)" required>
								...
								<div class="form-group col-6">
									<div class="mb-3">
										...
										<select class="form-control select2" id="kirimvia" name="kirimvia" required>
											<option value="">PILIHAN</option>
							...
							<div class="mb-3">
								...
								<input type="number" class="form-control" id="total" name="total" placeholder="NILAI TOTAL CETAKAN ANDA" maxlength="4" pattern="[0-9]+" required>
							</div>
						</div>
					</div>
